            ...
            <div class="flex flex-wrap ">
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <div class="relative lg:max-w-md">
                        <img src="{{URL::asset('storage/'.$about->image)}}" alt="aboutimage"
                        ...
                        <div
                            ...
                            <p class="text-lg font-semibold md:w-72">
                                ...
                                </svg> Successfully Providing instructive articles for 10 years
                            </p>
                        </div>
                    </div>
                </div>
                <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    <div class="content mb-6 text-base leading-7 text-gray-500 dark:text-gray-400">
                        {!! $about->content !!}
                    </div>
                    <a href="/"
                        class="px-4 py-2 text-gray-100 bg-blue-600 rounded dark:bg-blue-400 dark:hover:bg-blue-500 hover:bg-blue-600">
                        Learn more
                    </a>
                </div>
            </div>
